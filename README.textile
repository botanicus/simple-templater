...
if defined?(Gem) # try to find generators installed as gems
  ...
  Rango.logger.warn "Running without RubyGems which means SimpleTemplater won't be able to find generators distributed as a Gems."
...
- "Wiki":http://wiki.github.com/botanicus/simple-templater
